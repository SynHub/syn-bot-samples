...
namespace NLI_Database_Oscova
{
    ...
    public partial class MainWindow
    {
        ...
        public MainWindow()
        {
            ...
            Bot.Language.AddFilter(FilterType.Word, "=", "equal to");
            Bot.Language.AddFilter(FilterType.Word, ">", "greater than");
            Bot.Language.AddFilter(FilterType.Word, "<", "less than");
            Bot.Language.AddFilter(FilterType.Word, ">=", "greater than or equal to");
            Bot.Language.AddFilter(FilterType.Word, "<=", "less than or equal to");
            Bot.Language.AddFilter(FilterType.Word, "!=", "not equal to");
